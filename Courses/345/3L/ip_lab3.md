# In-person Assignment Lab 3: Simple Harmonic Motion

# Document Purpose
This is the in-person version of the third laboratory experiment performed in Physics 3L. 


## Pre-lab
:::Prelab
**Before coming to lab** you will need to complete **and submit on Gauchospace** your responses to [](#Exercise-HL1), [](#Exercise-SHM1), [](#Activity-leastSquares) and the exercises inside of it, namely [](#Exercise-bf1), [](#Exercise-bf2), [](#Exercise-bf3), [](#Exercise-bf4),[](#Exercise-bf5), as well as [](#Exercise-linearize), and [](#Exercise-procedure). This will be checked off by your TA when you get to class. 
...
4. Check the "My Line" box on the right. Note that the $a$ value represents the slope (we use $m$ in the lab manual), and the $b$ is the intercept.
...
:::Note
We will be using the value of $$g=9.79622\pm 0.00003$$ for the acceleration due to gravity.
:::
